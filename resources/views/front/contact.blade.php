    ...
    <div class="container">
            ...
            <div class="col-6">
                <form id="contact-form" class="d-flex flex-column align-items-center card border-0 p-3">
                    ...
                    <div class="input-group d-flex flex-column">
                        ...
                        <textarea id="message" name="message" class="form-control w-100 rounded-3" rows="10" placeholder="@lang('custom.enter-message')"></textarea>
                    </div>
        ...
        <div class="d-flex justify-content-center gap-3 mt-2">
            <div>
                ...
                <a href="mailto:info@suhail.ae" class="fw-bold">info@suhail.ae</a>
            </div>
            <div>
                <i class="fa-solid fa-phone"></i>
                <a href="tel:97155656552" class="fw-bold">+255757575779+</a>
            </div>
        </div>
    </div>
</section>

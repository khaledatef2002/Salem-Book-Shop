    ...
    <div>
        <div class="user-info d-flex align-items-center gap-3 mb-1">
            ...
            <div class="actions ms-auto d-flex gap-3">
                <form id="delete-auth-review-form" onsubmit="delete_review(event, this, {{ $review->seminar->id }})">
                    @csrf
                    @method('DELETE')
                    <button class="fa-solid fa-trash-can text-danger fs-5" type="submit"></button>
                </form>
                <form id="delete-auth-review-form" onsubmit="edit_review(event, this, {{ $review->seminar->id }})">

<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box py-2">
        ...
        <a href="{{ route('dashboard.index') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{ asset('front/'. $website_settings->logo) }}" alt="" height="40">
            </span>
            <span class="logo-lg">
                <img src="{{ asset('front/'. $website_settings->logo) }}" alt="" height="70">
            </span>
        </a>
        <!-- Light Logo-->
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ Route::currentRouteName() ==  'dashboard.index' ? 'active' : ''}}" href="" role="button">
